				...
				<div class="container">
					<div class="row">
						<div class="row border-bottom c-mb-md-50">
							<div class="col-md-8">
								<div class="media ">
									<img src="images/androidlogo.jpg" alt="">
									<div class="media-body">
										<h6>
											<a href="#">Native Android Development</a>
										</h6>
										<p>
											
Android makes up about 85% of the mobile market. Our experts have been developing Android apps for users and clients throughout the world. We use the latest tools and environments for Android development.
										</p>
						...
						<div class="row c-mb-md-40">
							...
							<div class="col-md-4">
								<ul>
									<li><a href="https://forms.gle/CyNHKwjy5zTXg5yR7">Apply Now</a></li>
